            ...
            <div className="hero min-h-screen bg-base-200 ">
                <div className="hero-content flex-col ">
                    ...
                    <div className="card flex-shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
                        ...
                        <button onClick={handleGoogleSign} className='flex items-center justify-center py-2 border border-black/10 rounded-3xl'>
                        ...
                        <button onClick={handleGithubSign} className='flex items-center  justify-center  py-2 border border-black/10 rounded-3xl'>
