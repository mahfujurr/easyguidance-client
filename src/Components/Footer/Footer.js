...
const Footer = () => {
    return (
        <div>
            <footer className="mt-16 footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
                <div className="items-center grid-flow-col">
                    ...
                    <p className='font-semibold'>Easy Guidance Ltd. <br /> Providing teaching services since 1992</p>
                </div>
            ...
            <footer className="footer p-10 bg-black text-white flex flex-row justify-between items-center ">
                <div>
